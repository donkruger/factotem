...
server.tool(
  'send_self',
  `Send a message back to the originating chat. The only outbound channel available to the open_dm profile. Cannot target other chats — text always goes to the chat that triggered this session.`,
  {
